...
1. Create or choose the correct folder under demos.
2. Add a local README that explains objective, prerequisites, setup, and validation.
3. Keep the demo reproducible in a clean environment.

## Folder Structure Rules

- Group by capability first: demos, agents, templates, experiments
